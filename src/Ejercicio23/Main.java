...
public class Main {
    public static void main(String[] args) throws Exception {
        Persona[] personas = devolverPersonas();

        imprimirPersona(personas);
        imprimirEmpleado(personas);
        imprimirProfesor(personas);
        imprimirPersonal(personas);
        imprimirEstudiante(personas);
    }

    private static void imprimirEstudiante(Persona[] personas) throws Exception {
    ...
    private static void imprimirPersonal(Persona[] personas) {
    ...
    private static void imprimirProfesor(Persona[] personas) {
    ...
    private static void imprimirEmpleado(Persona[] personas) {
    ...
    private static void imprimirPersona(Persona[] personas) throws Exception {
    ...
    public static Persona[] devolverPersonas() throws Exception {
        ...
        personas[3] = new PersonalServicio("Steven", "Seagal", "1481904J", "Pareja de hecho", 1987,4,"Cocicna");
